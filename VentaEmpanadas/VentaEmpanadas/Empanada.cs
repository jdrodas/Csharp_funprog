    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < lasEmpanadas.Length; i++)
            {
                ...
                lasEmpanadas[i].Color = tiposColores[aleatorio.Next(tiposColores.Length)];
                lasEmpanadas[i].Masa = tiposMasas[aleatorio.Next(tiposMasas.Length)];
                lasEmpanadas[i].Relleno = tiposRellenos[aleatorio.Next(tiposRellenos.Length)];
            }
            ...
            for (int i = 0; i < tiposMasas.Length; i++)
            {
                ...
                Console.WriteLine($"Para la masa {tiposMasas[i]} se hicieron {totalesPropiedad[i]} empanadas, {porcentaje.ToString("00.00")}%");
            ...
            {
                porcentaje = ((float)totalesPropiedad[i] / 1000) * 100;
                Console.WriteLine($"Para el relleno {tiposRellenos[i]} se hicieron {totalesPropiedad[i]} empanadas, {porcentaje.ToString("00.00")}%");
                totalValores += totalesPropiedad[i];
            }
            Console.WriteLine($"\n***Total Empanadas: {totalValores}");
            ...
            {
                porcentaje = ((float)totalesPropiedad[i] / 1000) * 100;
                Console.WriteLine($"Para el color {tiposColores[i]} se hicieron {totalesPropiedad[i]} empanadas, {porcentaje.ToString("00.00")}%");
                totalValores += totalesPropiedad[i];
            }
            Console.WriteLine($"\n***Total Empanadas: {totalValores}");
