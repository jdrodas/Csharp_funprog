    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (sumaDivisores == numero)
                Console.WriteLine("{0} es un número perfecto. Sus divisores suman igual que el número!", numero);
            else
                Console.WriteLine("{0} NO es un número perfecto. Sus divisores suman {1} que es diferente al número!", numero, sumaDivisores);
        }
    }
}