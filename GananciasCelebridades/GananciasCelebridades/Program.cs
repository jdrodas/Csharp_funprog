...
- Si la cifra es superior a 5,500$, se les descuenta un 35% único. Esto quiere decir, que no se adicionan los impuestos anteriores.
    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < nombreCelebridades.Length; i++)
                Console.WriteLine($"{nombreCelebridades[i]}, Salario: {salariosCelebridades[i]}");
