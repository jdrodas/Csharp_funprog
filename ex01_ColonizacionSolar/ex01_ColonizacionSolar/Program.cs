...
namespace ex01_ColonizacionSolar
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.Write("\nPor favor indique el destino del lanzamiento No. {0} (M/T/C): ", totalLanzamientos);
            ...
            Console.WriteLine("Total de lanzamientos a Marte fueron {0}", totalMarte);
            Console.WriteLine("Total de lanzamientos a Titán fueron {0}", totalTitan);
            Console.WriteLine("Total de lanzamientos al Cinturón de Asteroides fueron {0}", totalCinturon);
